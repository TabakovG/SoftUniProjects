...
namespace Drones
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            // Initialize entity
            Drone drone = new Drone("", "DEERC", 6);
            Drone drone1 = new Drone("D20", "", 6);
            Drone drone2= new Drone("D20", "DEERC", 6);
            Drone drone3 = new Drone("D20", "DEERC", 6);
            Drone drone4 = new Drone("D20", "DEERC", 6);
            ...
            Console.WriteLine(airfield.AddDrone(drone1));
            Console.WriteLine(airfield.AddDrone(drone2));
            Console.WriteLine(airfield.AddDrone(drone3));
            Console.WriteLine(airfield.AddDrone(drone4));
            ...
            Console.WriteLine(airfield.RemoveDroneByBrand("asd"));
            //Console.WriteLine(airfield.RemoveDroneByBrand("Autel"));
